...
const Profile = () => {
    ...
    const joinedDate = userInfo?.created_at ? new Date(userInfo.created_at).toLocaleDateString() : 'N/A';
  ...
  return (
    ...
    <div className="mt-4">
        ...
        <div className="mt-4">
            ...
            <div className="flex justify-between">
            <p>Role</p>
            <p className={`${role === "admin" ? " text-blue-500 " : " text-yellow-500"}`}>{capitalize(role || 'Member')}</p>
            </div>
